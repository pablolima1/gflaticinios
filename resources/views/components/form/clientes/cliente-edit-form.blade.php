...
<form action="{{ route('clientes.update' , ['id' => $cliente->id]) }}" method="POST" class="space-y-4">
    @csrf
    <x-common.component-card title="Preencha os dados do cliente">
    <!-- Nome Completo -->
    <div>
        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
            Nome Completo *
        </label>
        <input name="nome" type="text" placeholder="Fulano da Silva" value="{{ $cliente->nome }}"
    ...
    <div>
        ...
        <input x-mask:dynamic="$cpfCnpjMask($input)" name="cpf" type="text" placeholder="123.456.789-10" value="{{ $cliente->cpf }}"
            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
    </div>
    ...
    <div>
        ...
        <input name="rg" type="text" placeholder="MG12345678-10" value="{{ $cliente->rg }}"
            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
    </div>
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input name="email" type="text" placeholder="info@gmail.com" value="{{ $cliente->email }}"
    ...
    <div>
        ...
        <input x-mask="(99) 99999-9999" name="telefone" type="text" placeholder="(11) 99999-9999" value="{{ $cliente->telefone }}"
            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
    </div>
    <x-ui.button type="submit">Editar Cliente</x-ui.button>
