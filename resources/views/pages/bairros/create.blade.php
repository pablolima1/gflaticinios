...
@section('content')
    <div class="container mx-auto py-8">
        <div class="mb-6">
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Novo Bairro</h1>
            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Cadastre um bairro para vincular aos clientes.</p>
        </div>
        ...
        <div class="overflow-hidden rounded-3xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
            @include('pages.bairros._form', ['action' => route('bairros.store'), 'buttonText' => 'Criar'])
        </div>
    </div>
@endsection